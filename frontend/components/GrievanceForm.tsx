    ...
    return (
      ...
      >
        <div className="max-w-xl gov-card text-center mx-auto">
          <Icon name="check_circle" filled size={40} className="text-success mx-auto mb-4" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <ContentCard title="File a Grievance">
            {error && (
              <div className="mb-4 p-3 bg-red-50 text-red-800 border border-red-200 text-body-sm flex items-center gap-2" role="alert">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label htmlFor="category" className="block text-label-md text-on-surface mb-1.5">
                  Category *
                </label>
                <select
                  id="category"
                  ...
                  className="w-full border border-neutral-300 px-4 py-3 bg-white min-h-[44px]"
                  required
                >
              ...
              <div>
                <label htmlFor="subject" className="block text-label-md text-on-surface mb-1.5">
                  Subject *
                </label>
                <input
                  id="subject"
              ...
              <div>
                <label htmlFor="description" className="block text-label-md text-on-surface mb-1.5">
                  Description *
                </label>
                <textarea
                  id="description"
                  ...
                  className="w-full border border-neutral-300 px-4 py-3 bg-white resize-none"
                  required
                />
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="name" className="block text-label-md text-on-surface mb-1.5">
                    Your Name
                  </label>
                  <input
                    id="name"
              ...
              <button
                type="submit"
                disabled={submitting}
                className="btn-primary px-8 py-3 w-full sm:w-auto inline-flex items-center justify-center gap-2 disabled:opacity-60"
              >
        ...
        <div className="space-y-6">
          ...
          <ContentCard title="Already filed?">
            ...
            <Link href="/track" className="text-gov-link font-semibold hover:underline min-h-0">
